<div class="app-navbar-item">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
        ...
        <div class="row g-0">
            <!--begin:Item-->
            <div class="col-6">
                <a href="{{ asset('#') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="{{ asset('#') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="{{ asset('../dist/apps/projects/list.html') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
            ...
            <!--begin:Item-->
            <div class="col-6">
                <a href="{{ asset('#') }}" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
        ...
        <div class="py-2 text-center border-top">
            <a href="{{ asset('#') }}" class="btn btn-color-gray-600 btn-active-color-primary">View All
