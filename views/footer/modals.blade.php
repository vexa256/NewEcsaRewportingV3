				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							...
							<a href="{{ asset('#') }}" class="link-primary fw-bold">Pricing Guidelines</a>.</div>
						</div>
						<!--end::Heading-->
						<!--begin::Plans-->
								...
								<div class="col-lg-6 mb-10 mb-lg-0">
									...
									<div class="nav flex-column">
										...
										<label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_custom">
											...
											<!--begin::Price-->
											<div class="ms-5">
												<a href="{{ asset('#') }}" class="btn btn-sm btn-success">Contact Us</a>
											</div>
											<!--end::Price-->
										</label>
										<!--end::Tab link-->
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											...
											<a href="{{ asset('#') }}" class="link-primary fw-bold">Help Page</a>.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
								...
								<div data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="pb-10 pb-lg-15">
											...
											<!--begin::Notice-->
											<div class="text-muted fw-semibold fs-6">If you need more info, please check out
											<a href="{{ asset('#') }}" class="text-primary fw-bold">Help Page</a>.</div>
											<!--end::Notice-->
										</div>
										<!--end::Heading-->
										<!--begin::Input group-->
											...
											<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
												...
												<div class="d-flex flex-stack flex-grow-1">
													...
													<div class="fw-semibold">
														...
														<a href="{{ asset('../dist/utilities/wizards/vertical.html') }}" class="fw-bold">Create Team Platform</a></div>
													</div>
													<!--end::Content-->
												</div>
												<!--end::Wrapper-->
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							...
							<a href="{{ asset('#') }}" class="link-primary fw-bold">Users Directory</a>.</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
						<!--begin::Users-->
							...
							<div class="mh-375px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Emma Smith
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Melody Macy
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Max Smith
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Sean Bean
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Brian Cox
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Mikaela Collins
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Francis Mitcham
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Olivia Wild
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Neil Owen
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Dan Wilson
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Emma Bold
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Ana Crown
								...
								<div class="d-flex flex-stack py-5">
									...
									<div class="d-flex align-items-center">
										...
										<div class="ms-6">
											<!--begin::Name-->
											<a href="{{ asset('#') }}" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-primary">Robert Doe
						...
						<div id="kt_modal_users_search_handler" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="inline">
							...
							<div class="py-5">
								...
								<div data-kt-search-element="suggestions">
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										<!--begin::User-->
										<a href="{{ asset('#') }}" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
											<!--begin::Avatar-->
									...
									<div class="mh-375px scroll-y me-n7 pe-7">
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="0">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma Smith</a>
													<div class="fw-semibold text-muted">smith@kpmg.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="1">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Melody Macy</a>
													<div class="fw-semibold text-muted">melody@altbox.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Max Smith</a>
													<div class="fw-semibold text-muted">max@kt.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="3">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Sean Bean</a>
													<div class="fw-semibold text-muted">sean@dellito.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="4">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Brian Cox</a>
													<div class="fw-semibold text-muted">brian@exchange.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="5">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Mikaela Collins</a>
													<div class="fw-semibold text-muted">mik@pex.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Francis Mitcham</a>
													<div class="fw-semibold text-muted">f.mit@kpmg.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="7">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Olivia Wild</a>
													<div class="fw-semibold text-muted">olivia@corpmail.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="8">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Neil Owen</a>
													<div class="fw-semibold text-muted">owen.neil@gmail.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Dan Wilson</a>
													<div class="fw-semibold text-muted">dam@consilting.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="10">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Emma Bold</a>
													<div class="fw-semibold text-muted">emma@intenso.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Ana Crown</a>
													<div class="fw-semibold text-muted">ana.cf@limtel.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="12">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Robert Doe</a>
													<div class="fw-semibold text-muted">robert@benko.com</div>
												</div>
												<!--end::Details-->
											</div>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">John Miller</a>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="14">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Lucy Kunic</a>
										...
										<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Details-->
												<div class="ms-5">
													<a href="{{ asset('#') }}" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2">Ethan Wilder</a>
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<div class="text-center mb-13">
							...
							<a href="{{ asset('#') }}" class="link-primary fw-bold">FAQ Page</a>.</div>
							<!--end::Description-->
						</div>
						<!--end::Heading-->
